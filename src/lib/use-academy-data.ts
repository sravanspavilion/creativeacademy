...
/**
 * Fetch the academy configuration from the built-in /api route handlers with
 * a short timeout. Returns null when the API is unreachable or malformed so
 * the dashboard can fall back to bundled mock data.
 */
